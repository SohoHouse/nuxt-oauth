...
Handler.prototype.createAuth = function createAuth () {
  ...
  const oauthHost = typeof this.opts['oauthHost'] === 'function' ? this.opts['oauthHost'](this.req) : this.opts['oauthHost']
  const clientSecret = typeof this.opts['oauthClientSecret'] === 'function' ? this.opts['oauthClientSecret'](this.req) : this.opts['oauthClientSecret']
  const clientId = typeof this.opts['oauthClientID'] === 'function' ? this.opts['oauthClientID'](this.req) : this.opts['oauthClientID']
